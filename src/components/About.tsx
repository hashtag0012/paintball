...
export function About() {
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center pt-20 pb-6 px-6">
        <motion.img src="/pari.png"
          className="absolute top-[12%] left-[1%] md:left-[2%] w-56 md:w-80 h-auto object-contain rotate-[-11deg] drop-shadow-[0_16px_40px_rgba(0,0,0,0.9)] select-none pointer-events-none"
          alt="" draggable={false}
          variants={fadeLeft} initial="hidden" whileInView="show" viewport={{ once: true, margin: '-80px' }}
        />
        <motion.img src="/dich.png"
          className="absolute top-[8%] right-[1%] md:right-[2%] w-56 md:w-80 h-auto object-contain rotate-[8deg] drop-shadow-[0_16px_40px_rgba(0,0,0,0.9)] select-none pointer-events-none"
          alt="" draggable={false}
          variants={fadeRight} initial="hidden" whileInView="show" viewport={{ once: true, margin: '-80px' }}
        />
        <motion.img src="/fun.png"
          className="absolute bottom-[8%] left-[1%] md:left-[2%] w-52 md:w-72 h-auto object-contain rotate-[13deg] drop-shadow-[0_16px_40px_rgba(0,0,0,0.9)] select-none pointer-events-none"
          alt="" draggable={false}
          variants={fadeLeft} initial="hidden" whileInView="show" viewport={{ once: true, margin: '-80px' }}
        />
        <motion.img src="/team.png"
          className="absolute bottom-[6%] right-[1%] md:right-[2%] w-52 md:w-72 h-auto object-contain rotate-[-8deg] drop-shadow-[0_16px_40px_rgba(0,0,0,0.9)] select-none pointer-events-none"
          alt="" draggable={false}
          variants={fadeRight} initial="hidden" whileInView="show" viewport={{ once: true, margin: '-80px' }}
        />
        ...
        >
          <h2
            className="font-adrip text-6xl md:text-8xl text-white uppercase tracking-wide paint-drip-effect"
            style={{ textShadow: '4px 4px 0 hsl(var(--secondary))' }}
          >
            About Us
          </h2>
          <p className="font-graffiti text-lg md:text-2xl text-black leading-[2.2]">
          ...
          <p className="font-graffiti text-base md:text-xl text-black leading-[2.2]">
            <span className="bg-[hsl(var(--primary))] px-2 py-1 box-decoration-clone uppercase">
